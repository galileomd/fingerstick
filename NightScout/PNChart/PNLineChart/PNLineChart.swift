    ...
    var yLabels: NSArray = []{
        didSet{
            ...
            {  
                ...
                label.text = NSString(format:yLabelFormat, yValueMin.native + (yStep * index).native)
                ++index
                addSubview(label)
            }
        }
        ...
        didSet{
            ...
            for chart : AnyObject in chartData{
                ...
                for var i = 0; i < chartObj.itemCount; ++i{
					...
					yLabelsArray.addObject(NSString(format: "%2.1f", yValue.native))
                }
            }
    ...
    */
    ...
    override func drawRect(rect: CGRect)
    {
        if showCoordinateAxis {
            ...
            var font:UIFont = UIFont.systemFontOfSize(10)
            // draw y unit
            if yUnit != nil{
            ...
            // draw x unit
            if xUnit != nil {
                var height:CGFloat = heightOfString(yUnit, width:23.0, font:font)
